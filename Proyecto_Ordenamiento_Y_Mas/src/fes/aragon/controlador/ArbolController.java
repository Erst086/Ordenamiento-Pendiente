...
import fes.aragon.arbol.Node;
import javafx.event.ActionEvent;
import javafx.fxml.FXML;
import javafx.scene.control.Button;
import javafx.scene.control.TextArea;

public class ArbolController extends UniversalController {
    ...
    void Buscar(ActionEvent event) {
    	int a= main(null);
    	String b="+ * / - 5 21 7 10 5";
    	txtIngresar.setText(b);
    	txtSalNumeros.setText(String.valueOf(a));
    }
